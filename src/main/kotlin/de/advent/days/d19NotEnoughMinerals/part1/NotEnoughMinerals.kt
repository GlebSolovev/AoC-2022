package de.advent.days.d19NotEnoughMinerals.part1
...
private val opts = listOf(
    ...
    MaxOreResourcesOpt(16..MINUTES, 15),
    MaxClayResourcesOpt(0..MINUTES, 60),
    MaxObsResourcesOpt(0..MINUTES, 25),
    CraftStartRobotsOpt(0..10, 4),
    CraftStartRobotsOpt(11..MINUTES, 4),
    MaxRobotsOpt(0..MINUTES, maxOreRobots = 6, maxClayRobots = 15, maxObsRobots = 8)
)
...
fun main() {
    val res = readBlueprints().sumOf { blueprint ->
