package de.advent.days.d07nospaceleftondevice.part2
...
fun main() {
    ...
    val requiredSize = requiredSpace - freeSpace
    val result = dirs.map { it.size }.filter { size -> size >= requiredSize }.min()
    output(result)
}